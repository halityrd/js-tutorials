...
// meyveler.pop(); // Bir kez daha son elemanı siler.
meyveler.splice(meyveler.length - 2, 2); // sondan bir önceki elemandan başla iki adet sil.
...
console.log(yigit_not.toFixed(1), ada_not.toFixed(1), ahmet_not.toFixed(1)); // ondalıklı kısım kaç basamaklı olsun (1)