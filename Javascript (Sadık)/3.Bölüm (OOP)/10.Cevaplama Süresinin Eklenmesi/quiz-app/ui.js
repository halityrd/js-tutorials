...
function UI() {
    ...
    // script sayfasında anımadığımız StartTimer() fonksiyonunu aktarmak için .time_text ve .time_second classlarına sahip divleri seçip değişkenlere aktarıyoruz.
